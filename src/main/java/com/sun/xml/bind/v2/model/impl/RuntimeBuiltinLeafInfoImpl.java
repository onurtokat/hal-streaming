...
public abstract class RuntimeBuiltinLeafInfoImpl<T> extends BuiltinLeafInfoImpl<Type, Class> implements RuntimeBuiltinLeafInfo, Transducer<T>
{
    ...
    static {
        ...
        if (System.getProperty("mapAnyUriToUri") == null) {
            final QName[] array = array2 = new QName[9];
            array[0] = createXS("string");
            array[1] = createXS("normalizedString");
            array[2] = createXS("anyURI");
            array[3] = createXS("token");
            array[4] = createXS("language");
            array[5] = createXS("Name");
            array[6] = createXS("NCName");
            array[7] = createXS("NMTOKEN");
            array[8] = createXS("ENTITY");
        }
        else {
            final QName[] array3 = array2 = new QName[8];
            array3[0] = createXS("string");
            array3[1] = createXS("normalizedString");
            array3[2] = createXS("token");
            array3[3] = createXS("language");
            array3[4] = createXS("Name");
            array3[5] = createXS("NCName");
            array3[6] = createXS("NMTOKEN");
            array3[7] = createXS("ENTITY");
        }
        final QName[] qnames = array2;
