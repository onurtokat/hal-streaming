        ...
        for (int i = 0; i < length; ++i) {
            ...
            if (chr > '\u007f') {
                if (chr > '\u07ff') {
                    ...
                    this.buf[ptr++] = (byte)('\u00e0' + (chr >> 12));
                    this.buf[ptr++] = (byte)('\u0080' + (chr >> 6 & '?'));
                }
                else {
                    this.buf[ptr++] = (byte)('\u00c0' + (chr >> 6));
                }
        ...
        for (int i = 0; i < length; ++i) {
            ...
            if (chr > '\u007f') {
                if (chr > '\u07ff') {
                    ...
                    this.buf[ptr2++] = (byte)('\u00e0' + (chr >> 12));
                    this.buf[ptr2++] = (byte)('\u0080' + (chr >> 6 & '?'));
                }
                else {
                    this.buf[ptr2++] = (byte)('\u00c0' + (chr >> 6));
                }
