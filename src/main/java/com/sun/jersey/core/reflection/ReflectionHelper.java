...
public class ReflectionHelper
{
    ...
    public static Class classForName(final String name, final ClassLoader cl) {
        if (cl != null) {
            try {
    ...
    public static Class classForNameWithException(final String name) throws ClassNotFoundException {
        return classForNameWithException(name, getContextClassLoader());
    }
    
    public static Class classForNameWithException(final String name, final ClassLoader cl) throws ClassNotFoundException {
        if (cl != null) {
            try {
                return Class.forName(name, false, cl);
            }
    ...
    public static Method getValueOfStringMethod(final Class c) {
        try {
    ...
    public static Method getFromStringStringMethod(final Class c) {
        try {
    ...
    public static Constructor getStringConstructor(final Class c) {
        try {
