...
public class IntrospectionModeller
{
    ...
    private static void workOutPostConstructPreDestroy(final AbstractResource resource) {
        final Class postConstruct = ReflectionHelper.classForName("javax.annotation.PostConstruct");
        if (postConstruct == null) {
            return;
        }
        final Class preDestroy = ReflectionHelper.classForName("javax.annotation.PreDestroy");
