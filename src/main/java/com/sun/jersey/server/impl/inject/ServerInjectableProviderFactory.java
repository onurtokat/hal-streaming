...
public final class ServerInjectableProviderFactory extends InjectableProviderFactory implements ServerInjectableProviderContext
{
    ...
    @Override
    public InjectableScopePair getInjectableiWithScope(final Parameter p, final ComponentScope s) {
        return this.getInjectableiWithScope(null, p, s);
    }
    
    @Override
    public InjectableScopePair getInjectableiWithScope(final AccessibleObject ao, final Parameter p, final ComponentScope s) {
        ...
        if (i != null) {
            return new InjectableScopePair(i, ComponentScope.PerRequest);
        }
    ...
    public Injectable getInjectable(final AccessibleObject ao, final Parameter p, final ComponentScope s) {
        final InjectableScopePair isp = this.getInjectableiWithScope(ao, p, s);
        if (isp == null) {
            return null;
        }
        return isp.i;
