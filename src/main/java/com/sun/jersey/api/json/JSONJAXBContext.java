...
public final class JSONJAXBContext extends JAXBContext implements JSONConfigurated
{
    ...
    public JSONJAXBContext(final JSONConfiguration config, final Class... classesToBeBound) throws JAXBException {
        ...
        if (config.getNotation() == JSONConfiguration.Notation.NATURAL) {
            this.jaxbContext = JAXBContext.newInstance(classesToBeBound, Collections.singletonMap("retainReferenceToInfo", true));
        }
        else {
    ...
    public JSONJAXBContext(final JSONConfiguration config, final Class[] classesToBeBound, final Map<String, Object> properties) throws JAXBException {
        ...
        this.jsonConfiguration = config;
        if (config.getNotation() == JSONConfiguration.Notation.NATURAL) {
            final Map<String, Object> myProps = new HashMap<String, Object>(properties.size() + 1);
    ...
    public JSONJAXBContext(final JSONConfiguration config, final String contextPath) throws JAXBException {
        ...
        if (config.getNotation() == JSONConfiguration.Notation.NATURAL) {
            this.jaxbContext = JAXBContext.newInstance(contextPath, Thread.currentThread().getContextClassLoader(), Collections.singletonMap("retainReferenceToInfo", true));
        }
        else {
    ...
    public static JSONMarshaller getJSONMarshaller(final Marshaller marshaller) {
    ...
    public static JSONUnmarshaller getJSONUnmarshaller(final Unmarshaller unmarshaller) {
    ...
    private Map<String, Object> createProperties(final Map<String, Object> properties) {
        final Map<String, Object> workProperties = new HashMap<String, Object>();
    ...
    private final void processProperties(final Map<String, Object> properties) {
