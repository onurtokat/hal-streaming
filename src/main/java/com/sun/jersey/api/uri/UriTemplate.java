...
public class UriTemplate
{
    ...
    private UriTemplate() {
        ...
        this.numOfCharacters = (b ? 1 : 0);
        this.numOfExplicitRegexes = (b ? 1 : 0);
    }
    ...
    private static StringBuilder createURIComponent(final UriComponent.Type t, String template, final Map<String, ?> values, final boolean encode, final StringBuilder b) {
