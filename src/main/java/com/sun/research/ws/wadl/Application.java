...
public class Application
{
    ...
    @XmlElements({ @XmlElement(name = "method", type = Method.class), @XmlElement(name = "resource_type", type = ResourceType.class), @XmlElement(name = "param", type = Param.class), @XmlElement(name = "representation", type = Representation.class) })
