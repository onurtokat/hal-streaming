...
public class IdentityMap<K, V>
{
    ...
    public Entries<K, V> entries() {
        if (this.entries == null) {
            this.entries = new Entries((IdentityMap<K, V>)this);
        }
        else {
            this.entries.reset();
        }
    ...
    public Values<V> values() {
        if (this.values == null) {
            this.values = new Values((IdentityMap<?, V>)this);
        }
        else {
            this.values.reset();
        }
    ...
    public Keys<K> keys() {
        if (this.keys == null) {
            this.keys = new Keys((IdentityMap<K, ?>)this);
        }
        else {
            this.keys.reset();
        }
    ...
    private static class MapIterator<K, V>
    {
        ...
        public MapIterator(final IdentityMap<K, V> map) {
            this.map = map;
            this.reset();
        }
        ...
        public void remove() {
            ...
            this.currentIndex = -1;
            final IdentityMap<K, V> map = this.map;
            --map.size;
        }
    }
    ...
    public static class Entries<K, V> extends MapIterator<K, V> implements Iterable<Entry<K, V>>, Iterator<Entry<K, V>>
    {
        ...
        public Entries(final IdentityMap<K, V> map) {
            super(map);
    ...
    {
        public Values(final IdentityMap<?, V> map) {
            super(map);
        }
    ...
    {
        public Keys(final IdentityMap<K, ?> map) {
            super(map);
        }
