...
public class BeanPropertyWriter extends PropertyWriter implements BeanProperty
{
    ...
    public void serializeAsField(final Object bean, final JsonGenerator jgen, final SerializerProvider prov) throws Exception {
        final Object value = (this._accessorMethod == null) ? this._field.get(bean) : this._accessorMethod.invoke(bean, new Object[0]);
        if (value == null) {
    ...
    @Override
    public void depositSchemaProperty(final JsonObjectFormatVisitor v) throws JsonMappingException {
        if (v != null) {
            if (this.isRequired()) {
                v.property(this);
            }
