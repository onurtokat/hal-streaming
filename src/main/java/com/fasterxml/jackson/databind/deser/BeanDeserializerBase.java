...
public abstract class BeanDeserializerBase extends StdDeserializer<Object> implements ContextualDeserializer, ResolvableDeserializer, Serializable
{
    ...
    protected Object _convertObjectId(final JsonParser jp, final DeserializationContext ctxt, final Object rawId, final JsonDeserializer<Object> idDeser) throws IOException {
    ...
    protected Object deserializeWithObjectId(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
        return this.deserializeFromObject(jp, ctxt);
    }
    
    protected Object deserializeFromObjectId(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
    ...
    protected Object deserializeFromObjectUsingNonDefault(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
    ...
    public Object deserializeFromNumber(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
        if (this._objectIdReader != null) {
            return this.deserializeFromObjectId(jp, ctxt);
        }
    ...
    public Object deserializeFromString(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
        if (this._objectIdReader != null) {
            return this.deserializeFromObjectId(jp, ctxt);
        }
    ...
    public Object deserializeFromDouble(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
        switch (jp.getNumberType()) {
            case FLOAT:
            case DOUBLE: {
    ...
    public Object deserializeFromBoolean(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
    ...
    public Object deserializeFromArray(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
        if (this._delegateDeserializer != null) {
            try {
                final Object bean = this._valueInstantiator.createUsingDelegate(ctxt, this._delegateDeserializer.deserialize(jp, ctxt));
                if (this._injectables != null) {
    ...
    public Object deserializeFromEmbedded(final JsonParser jp, final DeserializationContext ctxt) throws IOException {
        if (this._objectIdReader != null) {
            return this.deserializeFromObjectId(jp, ctxt);
        }
