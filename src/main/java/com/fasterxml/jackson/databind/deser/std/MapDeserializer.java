...
public class MapDeserializer extends ContainerDeserializerBase<Map<Object, Object>> implements ContextualDeserializer, ResolvableDeserializer
{
        ...
        while (t == JsonToken.FIELD_NAME) {
            ...
            if (this._ignorableProperties != null && this._ignorableProperties.contains(fieldName)) {
                ...
                try {
                    ...
                    this.wrapAndThrow(e, result, fieldName);
                }
            }
            t = jp.nextToken();
        }
    ...
    public Map<Object, Object> _deserializeUsingCreator(final JsonParser jp, final DeserializationContext ctxt) throws IOException, JsonProcessingException {
                ...
                if (prop != null) {
                    ...
                    if (buffer.assignParameter(prop.getCreatorIndex(), value)) {
                        ...
                        try {
                            ...
                            this.wrapAndThrow(e, this._mapType.getRawClass(), propName);
                            return null;
                        }
                        this._readAndBind(jp, ctxt, result);
                        return result;
                    ...
                    try {
                        ...
                        this.wrapAndThrow(e2, this._mapType.getRawClass(), propName);
                        return null;
                    }
        ...
        try {
            ...
            this.wrapAndThrow(e3, this._mapType.getRawClass(), null);
            return null;
        }
    }
    
    @Deprecated
    protected void wrapAndThrow(final Throwable t, final Object ref) throws IOException {
        this.wrapAndThrow(t, ref, null);
    }
    
    protected void wrapAndThrow(Throwable t, final Object ref, final String key) throws IOException {
