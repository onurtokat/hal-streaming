...
public class BeanDeserializer extends BeanDeserializerBase implements Serializable
{
    ...
    protected final Object _deserializeOther(final JsonParser jp, final DeserializationContext ctxt, final JsonToken t) throws IOException {
        switch (t) {
            case VALUE_STRING: {
            ...
            case VALUE_EMBEDDED_OBJECT: {
                return this.deserializeFromEmbedded(jp, ctxt);
            }
            case VALUE_TRUE:
            case VALUE_FALSE: {
