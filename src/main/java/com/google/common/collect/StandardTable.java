...
class StandardTable<R, C, V> extends AbstractTable<R, C, V> implements Serializable
{
    ...
    private class Column extends Maps.ImprovedAbstractMap<R, V>
    {
        ...
        private class KeySet extends Maps.KeySet<R, V>
        {
            ...
            @Override
            public boolean retainAll(final Collection<?> c) {
                return Column.this.removeFromColumnIf((Predicate<? super Entry<R, V>>)Maps.keyPredicateOnEntries(Predicates.not(Predicates.in((Collection<? extends K>)c))));
            }
        }
        ...
        private class Values extends Maps.Values<R, V>
        {
            ...
            @Override
            public boolean remove(final Object obj) {
                return obj != null && Column.this.removeFromColumnIf((Predicate<? super Entry<R, V>>)Maps.valuePredicateOnEntries(Predicates.equalTo(obj)));
            }
            
            @Override
            public boolean removeAll(final Collection<?> c) {
                return Column.this.removeFromColumnIf((Predicate<? super Entry<R, V>>)Maps.valuePredicateOnEntries(Predicates.in(c)));
            }
            
            @Override
            public boolean retainAll(final Collection<?> c) {
                return Column.this.removeFromColumnIf((Predicate<? super Entry<R, V>>)Maps.valuePredicateOnEntries(Predicates.not(Predicates.in((Collection<? extends V>)c))));
            }
        }
    }
    ...
    private class ColumnMap extends Maps.ImprovedAbstractMap<C, Map<R, V>>
    {
        ...
        private class ColumnMapValues extends Maps.Values<C, Map<R, V>>
        {
            ...
            @Override
            public boolean remove(final Object obj) {
                for (final Entry<C, Map<R, V>> entry : ColumnMap.this.entrySet()) {
