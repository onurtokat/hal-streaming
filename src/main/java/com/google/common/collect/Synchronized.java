...
final class Synchronized
{
    ...
    static class SynchronizedNavigableMap<K, V> extends SynchronizedSortedMap<K, V> implements NavigableMap<K, V>
    {
        ...
        public Entry<K, V> ceilingEntry(final K key) {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().ceilingEntry(key), this.mutex);
            }
        }
        ...
        public Entry<K, V> firstEntry() {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().firstEntry(), this.mutex);
            }
        }
        ...
        public Entry<K, V> floorEntry(final K key) {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().floorEntry(key), this.mutex);
            }
        }
        ...
        public Entry<K, V> higherEntry(final K key) {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().higherEntry(key), this.mutex);
            }
        }
        ...
        public Entry<K, V> lastEntry() {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().lastEntry(), this.mutex);
            }
        }
        ...
        public Entry<K, V> lowerEntry(final K key) {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().lowerEntry(key), this.mutex);
            }
        }
        ...
        public Entry<K, V> pollFirstEntry() {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().pollFirstEntry(), this.mutex);
            }
        }
        ...
        public Entry<K, V> pollLastEntry() {
            synchronized (this.mutex) {
                return (Entry<K, V>)nullableSynchronizedEntry((Entry<Object, Object>)this.delegate().pollLastEntry(), this.mutex);
            }
        }
