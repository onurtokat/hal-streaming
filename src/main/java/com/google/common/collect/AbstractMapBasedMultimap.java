...
abstract class AbstractMapBasedMultimap<K, V> extends AbstractMultimap<K, V> implements Serializable
{
    ...
    private class AsMap extends Maps.ImprovedAbstractMap<K, Collection<V>>
    {
        ...
        class AsMapIterator implements Iterator<Entry<K, Collection<V>>>
        {
            ...
            public Entry<K, Collection<V>> next() {
                final Entry<K, Collection<V>> entry = this.delegateIterator.next();
    ...
    class NavigableAsMap extends SortedAsMap implements NavigableMap<K, Collection<V>>
    {
        ...
        @Override
        public Entry<K, Collection<V>> lowerEntry(final K key) {
            final Entry<K, Collection<V>> entry = this.sortedMap().lowerEntry(key);
        ...
        @Override
        public Entry<K, Collection<V>> floorEntry(final K key) {
            final Entry<K, Collection<V>> entry = this.sortedMap().floorEntry(key);
            return (entry == null) ? null : this.wrapEntry(entry);
        }
        ...
        @Override
        public Entry<K, Collection<V>> ceilingEntry(final K key) {
            final Entry<K, Collection<V>> entry = this.sortedMap().ceilingEntry(key);
            return (entry == null) ? null : this.wrapEntry(entry);
        }
        ...
        @Override
        public Entry<K, Collection<V>> higherEntry(final K key) {
            final Entry<K, Collection<V>> entry = this.sortedMap().higherEntry(key);
            return (entry == null) ? null : this.wrapEntry(entry);
        }
        ...
        public Entry<K, Collection<V>> firstEntry() {
            final Entry<K, Collection<V>> entry = this.sortedMap().firstEntry();
            return (entry == null) ? null : this.wrapEntry(entry);
        }
        
        @Override
        public Entry<K, Collection<V>> lastEntry() {
            final Entry<K, Collection<V>> entry = this.sortedMap().lastEntry();
            return (entry == null) ? null : this.wrapEntry(entry);
        }
        ...
        Entry<K, Collection<V>> pollAsMapEntry(final Iterator<Entry<K, Collection<V>>> entryIterator) {
