                    ...
                    return new AbstractIterator<Entry<K, Collection<V>>>() {
                        ...
                        protected Entry<K, Collection<V>> computeNext() {
                            while (this.backingIterator.hasNext()) {
                                final Entry<K, Collection<V>> entry = this.backingIterator.next();
                                final K key = entry.getKey();
            ...
            return (Collection<Collection<V>>)new Maps.Values<K, Collection<V>>(this) {
                ...
                public boolean remove(@Nullable final Object o) {
                    if (o instanceof Collection) {
                        ...
                        final Iterator<Entry<K, Collection<V>>> entryIterator = FilteredEntryMultimap.this.unfiltered.asMap().entrySet().iterator();
                        while (entryIterator.hasNext()) {
    ...
    class Keys extends Multimaps.Keys<K, V>
    {
        ...
        public Set<Entry<K>> entrySet() {
            return (Set<Entry<K>>)new Multisets.EntrySet<K>() {
                ...
                @Override
                public boolean removeAll(final Collection<?> c) {
                    return this.removeEntriesIf(Predicates.in((Collection<? extends Entry<K>>)c));
                }
                
                @Override
                public boolean retainAll(final Collection<?> c) {
                    return this.removeEntriesIf(Predicates.not(Predicates.in((Collection<? extends Entry<K>>)c)));
                }
            };
        }
    }
