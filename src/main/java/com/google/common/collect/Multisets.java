...
public final class Multisets
{
    ...
    public static <E> Multiset<E> union(final Multiset<? extends E> multiset1, final Multiset<? extends E> multiset2) {
        ...
        return new AbstractMultiset<E>() {
            ...
            Iterator<Entry<E>> entryIterator() {
                final Iterator<? extends Entry<? extends E>> iterator1 = (Iterator<? extends Entry<? extends E>>)multiset1.entrySet().iterator();
                final Iterator<? extends Entry<? extends E>> iterator2 = (Iterator<? extends Entry<? extends E>>)multiset2.entrySet().iterator();
                return new AbstractIterator<Entry<E>>() {
                    @Override
                    protected Entry<E> computeNext() {
                        if (iterator1.hasNext()) {
                            final Entry<? extends E> entry1 = iterator1.next();
                            final E element = (E)entry1.getElement();
                            final int count = Math.max(entry1.getCount(), multiset2.count(element));
                            return Multisets.immutableEntry(element, count);
                        }
                        while (iterator2.hasNext()) {
                            final Entry<? extends E> entry2 = iterator2.next();
                ...
                return new AbstractIterator<Entry<E>>() {
                    ...
                    protected Entry<E> computeNext() {
                        while (iterator1.hasNext()) {
                            final Entry<E> entry1 = iterator1.next();
    ...
    static class UnmodifiableMultiset<E> extends ForwardingMultiset<E> implements Serializable
    {
        ...
        public Set<Entry<E>> entrySet() {
            final Set<Entry<E>> es = this.entrySet;
            return (es == null) ? (this.entrySet = Collections.unmodifiableSet((Set<? extends Entry<E>>)this.delegate.entrySet())) : es;
        }
