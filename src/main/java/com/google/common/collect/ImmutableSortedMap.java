...
public abstract class ImmutableSortedMap<K, V> extends ImmutableSortedMapFauxverideShim<K, V> implements NavigableMap<K, V>
{
    ...
    static <K, V> ImmutableSortedMap<K, V> fromSortedEntries(final Comparator<? super K> comparator, final int size, final Entry<K, V>[] entries) {
        if (size == 0) {
    ...
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> of(final K k1, final V v1, final K k2, final V v2) {
        return fromEntries(Ordering.natural(), false, 2, (Entry<K, V>[])new Entry[] { ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2) });
    }
    ...
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> of(final K k1, final V v1, final K k2, final V v2, final K k3, final V v3) {
        return fromEntries(Ordering.natural(), false, 3, (Entry<K, V>[])new Entry[] { ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3) });
    }
    ...
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> of(final K k1, final V v1, final K k2, final V v2, final K k3, final V v3, final K k4, final V v4) {
        return fromEntries(Ordering.natural(), false, 4, (Entry<K, V>[])new Entry[] { ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4) });
    }
    ...
    public static <K extends Comparable<? super K>, V> ImmutableSortedMap<K, V> of(final K k1, final V v1, final K k2, final V v2, final K k3, final V v3, final K k4, final V v4, final K k5, final V v5) {
        return fromEntries(Ordering.natural(), false, 5, (Entry<K, V>[])new Entry[] { ImmutableMap.entryOf(k1, v1), ImmutableMap.entryOf(k2, v2), ImmutableMap.entryOf(k3, v3), ImmutableMap.entryOf(k4, v4), ImmutableMap.entryOf(k5, v5) });
    }
    ...
    static <K, V> ImmutableSortedMap<K, V> fromEntries(final Comparator<? super K> comparator, final boolean sameComparator, final int size, final Entry<K, V>... entries) {
    ...
    private static <K, V> void sortEntries(final Comparator<? super K> comparator, final int size, final Entry<K, V>[] entries) {
        Arrays.sort(entries, 0, size, (Comparator<? super Entry<K, V>>)Ordering.from(comparator).onKeys());
    }
    
    private static <K, V> void validateEntries(final int size, final Entry<K, V>[] entries, final Comparator<? super K> comparator) {
    ...
    private static class SerializedForm extends ImmutableMap.SerializedForm
    {
        ...
        @Override
        Object readResolve() {
            final Builder<Object, Object> builder = new Builder<Object, Object>(this.comparator);
