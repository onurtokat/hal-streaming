...
public final class MapConstraints
{
    ...
    static class ConstrainedMap<K, V> extends ForwardingMap<K, V>
    {
        ...
        public Set<Entry<K, V>> entrySet() {
            ...
            if (result == null) {
                result = (this.entrySet = (Set<Entry<K, V>>)constrainedEntrySet((Set<Entry<Object, Object>>)this.delegate.entrySet(), this.constraint));
            }
            return result;
        }
            ...
            if (result == null) {
                ...
                result = (this.asMap = new ForwardingMap<K, Collection<V>>() {
                    ...
                    public Set<Entry<K, Collection<V>>> entrySet() {
                        ...
                        if (result == null) {
                            result = (this.entrySet = (Set<Entry<K, Collection<V>>>)constrainedAsMapEntries((Set<Entry<Object, Collection<Object>>>)asMapDelegate.entrySet(), ConstrainedMultimap.this.constraint));
                        }
                        return result;
                    }
