...
public final class Maps
{
    ...
    {
        SortedMapDifferenceImpl(final SortedMap<K, V> onlyOnLeft, final SortedMap<K, V> onlyOnRight, final SortedMap<K, V> onBoth, final SortedMap<K, ValueDifference<V>> differences) {
    ...
    static class TransformedEntriesMap<K, V1, V2> extends ImprovedAbstractMap<K, V2>
    {
        ...
        protected Set<Entry<K, V2>> createEntrySet() {
            return (Set<Entry<K, V2>>)new EntrySet<K, V2>() {
                @Override
                Map<K, V2> map() {
                ...
                public Iterator<Entry<K, V2>> iterator() {
                    return Iterators.transform(TransformedEntriesMap.this.fromMap.entrySet().iterator(), (Function<? super Entry<K, V1>, ? extends Entry<K, V2>>)Maps.asEntryToEntryFunction((EntryTransformer<? super Object, ? super Object, V2>)TransformedEntriesMap.this.transformer));
                }
            };
        }
    }
    ...
    private static class TransformedEntriesNavigableMap<K, V1, V2> extends TransformedEntriesSortedMap<K, V1, V2> implements NavigableMap<K, V2>
    {
        ...
        @Override
        public Entry<K, V2> ceilingEntry(final K key) {
        ...
        @Override
        public Entry<K, V2> floorEntry(final K key) {
        ...
        @Override
        public Entry<K, V2> higherEntry(final K key) {
        ...
        @Override
        public Entry<K, V2> lowerEntry(final K key) {
    ...
    private static class FilteredKeyMap<K, V> extends AbstractFilteredMap<K, V>
    {
        ...
        FilteredKeyMap(final Map<K, V> unfiltered, final Predicate<? super K> keyPredicate, final Predicate<? super Entry<K, V>> entryPredicate) {
    ...
    static class FilteredEntryMap<K, V> extends AbstractFilteredMap<K, V>
    {
        ...
        FilteredEntryMap(final Map<K, V> unfiltered, final Predicate<? super Entry<K, V>> entryPredicate) {
            super(unfiltered, entryPredicate);
        ...
        class KeySet extends Maps.KeySet<K, V>
        {
            ...
            private boolean removeIf(final Predicate<? super K> keyPredicate) {
                return Iterables.removeIf(FilteredEntryMap.this.unfiltered.entrySet(), Predicates.and(FilteredEntryMap.this.predicate, (Predicate<? super Entry<K, V>>)Maps.keyPredicateOnEntries((Predicate<? super Object>)keyPredicate)));
            }
    ...
    {
        FilteredEntrySortedMap(final SortedMap<K, V> unfiltered, final Predicate<? super Entry<K, V>> entryPredicate) {
            super(unfiltered, entryPredicate);
        }
        ...
        @Override
        public SortedMap<K, V> headMap(final K toKey) {
            return new FilteredEntrySortedMap((SortedMap<Object, Object>)this.sortedMap().headMap(toKey), (Predicate<? super Entry<Object, Object>>)this.predicate);
        }
        
        @Override
        public SortedMap<K, V> subMap(final K fromKey, final K toKey) {
            return new FilteredEntrySortedMap((SortedMap<Object, Object>)this.sortedMap().subMap(fromKey, toKey), (Predicate<? super Entry<Object, Object>>)this.predicate);
        }
        
        @Override
        public SortedMap<K, V> tailMap(final K fromKey) {
            return new FilteredEntrySortedMap((SortedMap<Object, Object>)this.sortedMap().tailMap(fromKey), (Predicate<? super Entry<Object, Object>>)this.predicate);
        }
    ...
    private static class FilteredEntryNavigableMap<K, V> extends AbstractNavigableMap<K, V>
    {
        ...
        FilteredEntryNavigableMap(final NavigableMap<K, V> unfiltered, final Predicate<? super Entry<K, V>> entryPredicate) {
        ...
        @Override
        Iterator<Entry<K, V>> entryIterator() {
            return (Iterator<Entry<K, V>>)Iterators.filter(this.unfiltered.entrySet().iterator(), (Predicate<? super Entry<Object, Object>>)this.entryPredicate);
        }
        
        @Override
        Iterator<Entry<K, V>> descendingEntryIterator() {
            return (Iterator<Entry<K, V>>)Iterators.filter(this.unfiltered.descendingMap().entrySet().iterator(), (Predicate<? super Entry<Object, Object>>)this.entryPredicate);
        }
        ...
        public Entry<K, V> pollFirstEntry() {
            return Iterables.removeFirstMatching((Iterable<Entry<K, V>>)this.unfiltered.entrySet(), this.entryPredicate);
        }
        
        @Override
        public Entry<K, V> pollLastEntry() {
            return Iterables.removeFirstMatching((Iterable<Entry<K, V>>)this.unfiltered.descendingMap().entrySet(), this.entryPredicate);
        }
    ...
    static final class FilteredEntryBiMap<K, V> extends FilteredEntryMap<K, V> implements BiMap<K, V>
    {
        ...
        private static <K, V> Predicate<Entry<V, K>> inversePredicate(final Predicate<? super Entry<K, V>> forwardPredicate) {
            return new Predicate<Entry<V, K>>() {
                @Override
                public boolean apply(final Entry<V, K> input) {
                    return forwardPredicate.apply(Maps.immutableEntry(input.getValue(), input.getKey()));
                }
            };
        }
        
        FilteredEntryBiMap(final BiMap<K, V> delegate, final Predicate<? super Entry<K, V>> predicate) {
            super(delegate, predicate);
            this.inverse = (BiMap<V, K>)new FilteredEntryBiMap((BiMap<Object, Object>)delegate.inverse(), inversePredicate((Predicate<? super Entry<Object, Object>>)predicate), (BiMap<Object, Object>)this);
        }
        
        private FilteredEntryBiMap(final BiMap<K, V> delegate, final Predicate<? super Entry<K, V>> predicate, final BiMap<V, K> inverse) {
            super(delegate, predicate);
            this.inverse = inverse;
        }
    ...
    static class UnmodifiableNavigableMap<K, V> extends ForwardingSortedMap<K, V> implements NavigableMap<K, V>, Serializable
    {
        ...
        public Entry<K, V> lowerEntry(final K key) {
            return (Entry<K, V>)unmodifiableOrNull((Entry<Object, Object>)this.delegate.lowerEntry(key));
        }
        ...
        public Entry<K, V> floorEntry(final K key) {
            return (Entry<K, V>)unmodifiableOrNull((Entry<Object, Object>)this.delegate.floorEntry(key));
        }
        ...
        public Entry<K, V> ceilingEntry(final K key) {
            return (Entry<K, V>)unmodifiableOrNull((Entry<Object, Object>)this.delegate.ceilingEntry(key));
        }
        ...
        public Entry<K, V> higherEntry(final K key) {
            return (Entry<K, V>)unmodifiableOrNull((Entry<Object, Object>)this.delegate.higherEntry(key));
        }
        ...
        public Entry<K, V> firstEntry() {
            return (Entry<K, V>)unmodifiableOrNull((Entry<Object, Object>)this.delegate.firstEntry());
        }
        
        @Override
        public Entry<K, V> lastEntry() {
            return (Entry<K, V>)unmodifiableOrNull((Entry<Object, Object>)this.delegate.lastEntry());
        }
    ...
    abstract static class ImprovedAbstractMap<K, V> extends AbstractMap<K, V>
    {
        ...
        @Override
        public Set<Entry<K, V>> entrySet() {
            final Set<Entry<K, V>> result = this.entrySet;
