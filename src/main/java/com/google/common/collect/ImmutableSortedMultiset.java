...
public abstract class ImmutableSortedMultiset<E> extends ImmutableSortedMultisetFauxverideShim<E> implements SortedMultiset<E>
{
    ...
    public static <E> ImmutableSortedMultiset<E> copyOf(final Comparator<? super E> comparator, Iterable<? extends E> elements) {
        if (elements instanceof ImmutableSortedMultiset) {
            ...
            if (comparator.equals(multiset.comparator())) {
                if (multiset.isPartialView()) {
                    return copyOfSortedEntries(comparator, (Collection<Entry<E>>)multiset.entrySet().asList());
                }
                return multiset;
            }
        }
        ...
        return copyOfSortedEntries(comparator, (Collection<Entry<E>>)sortedCopy.entrySet());
    }
    ...
    private static <E> ImmutableSortedMultiset<E> copyOfSortedEntries(final Comparator<? super E> comparator, final Collection<Entry<E>> entries) {
        if (entries.isEmpty()) {
    ...
    private static final class SerializedForm<E> implements Serializable
    {
        ...
        SerializedForm(final SortedMultiset<E> multiset) {
            ...
            int i = 0;
            for (final Entry<E> entry : multiset.entrySet()) {
