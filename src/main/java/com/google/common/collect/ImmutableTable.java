...
public abstract class ImmutableTable<R, C, V> extends AbstractTable<R, C, V>
{
    ...
    public static <R, C, V> ImmutableTable<R, C, V> copyOf(final Table<? extends R, ? extends C, ? extends V> table) {
        ...
        switch (size) {
            ...
            case 1: {
                final Cell<? extends R, ? extends C, ? extends V> onlyCell = Iterables.getOnlyElement(table.cellSet());
                return of((R)onlyCell.getRowKey(), (C)onlyCell.getColumnKey(), (V)onlyCell.getValue());
            }
            default: {
                final ImmutableSet.Builder<Cell<R, C, V>> cellSetBuilder = ImmutableSet.builder();
    ...
    static <R, C, V> Cell<R, C, V> cellOf(final R rowKey, final C columnKey, final V value) {
