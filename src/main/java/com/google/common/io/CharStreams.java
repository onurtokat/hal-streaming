...
public final class CharStreams
{
    ...
    @Deprecated
    public static <R extends Readable, W extends Appendable> long copy(final InputSupplier<R> from, final OutputSupplier<W> to) throws IOException {
        return asCharSource((InputSupplier<? extends Readable>)from).copyTo(asCharSink((OutputSupplier<? extends Appendable>)to));
    }
    
    @Deprecated
    public static <R extends Readable> long copy(final InputSupplier<R> from, final Appendable to) throws IOException {
    ...
    @Deprecated
    public static <R extends Readable> String toString(final InputSupplier<R> supplier) throws IOException {
    ...
    @Deprecated
    public static <R extends Readable> String readFirstLine(final InputSupplier<R> supplier) throws IOException {
        return asCharSource((InputSupplier<? extends Readable>)supplier).readFirstLine();
    }
    
    @Deprecated
    public static <R extends Readable> List<String> readLines(final InputSupplier<R> supplier) throws IOException {
    ...
    @Deprecated
    public static <R extends Readable, T> T readLines(final InputSupplier<R> supplier, final LineProcessor<T> callback) throws IOException {
