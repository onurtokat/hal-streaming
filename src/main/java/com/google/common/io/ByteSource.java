...
public abstract class ByteSource implements InputSupplier<InputStream>
{
    ...
    public long size() throws IOException {
        ...
        try {
            ...
            final InputStream \u0131nputStream = byteSource.openStream();
            final InputStream \u0131nputStream2 = create.register(\u0131nputStream);
            final InputStream in = \u0131nputStream2;
            final ByteSource byteSource2 = this;
            final InputStream \u0131nputStream3 = in;
            final long countByReading = byteSource2.countByReading(\u0131nputStream3);
        ...
        try {
            ...
            final long countByReading = countByReading2 = byteSource2.countByReading(\u0131nputStream3);
