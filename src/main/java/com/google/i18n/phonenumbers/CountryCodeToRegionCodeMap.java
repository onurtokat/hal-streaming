...
public class CountryCodeToRegionCodeMap
{
    static Map<Integer, List<String>> getCountryCodeToRegionCodeMap() {
        final Map<Integer, List<String>> countryCodeToRegionCodeMap = new HashMap<Integer, List<String>>(286);
        ArrayList<String> listWithRegionCode = new ArrayList<String>(25);
