...
public final class ReflectiveTypeAdapterFactory implements TypeAdapterFactory
{
    ...
    static List<String> getFieldName(final FieldNamingStrategy fieldNamingPolicy, final Field f) {
    ...
    TypeAdapter<?> getFieldAdapter(final Gson gson, final Field field, final TypeToken<?> fieldType) {
