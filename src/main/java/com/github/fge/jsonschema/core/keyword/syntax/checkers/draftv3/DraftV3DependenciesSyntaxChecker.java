...
public final class DraftV3DependenciesSyntaxChecker extends DependenciesSyntaxChecker
{
    ...
    public static SyntaxChecker getInstance() {
        return DraftV3DependenciesSyntaxChecker.INSTANCE;
    }
    
    private DraftV3DependenciesSyntaxChecker() {
        super(new NodeType[] { NodeType.ARRAY, NodeType.STRING });
    }
    ...
    protected void checkDependency(final ProcessingReport report, final MessageBundle bundle, final String name, final SchemaTree tree) throws ProcessingException {
        ...
        for (int index = 0; index < size; ++index) {
            ...
            uniqueElements = set.add(DraftV3DependenciesSyntaxChecker.EQUIVALENCE.wrap(element));
            if (type != NodeType.STRING) {
    ...
    static {
        INSTANCE = new DraftV3DependenciesSyntaxChecker();
    }
}
