...
{
    public static final Injection$ MODULE$;
    ...
    @Override
    public <A, B> Injection<Option<A>, Option<B>> optionInjection(final Injection<A, B> inj) {
        return (Injection<Option<A>, Option<B>>)CollectionInjections$class.optionInjection(this, inj);
    }
    
    @Override
    public <V1, V2> Injection<Option<V1>, List<V2>> option2List(final Injection<V1, V2> inj) {
        return (Injection<Option<V1>, List<V2>>)CollectionInjections$class.option2List(this, inj);
    }
    
    @Override
    public <K1, V1, V2> Injection<Map<K1, V1>, Set<V2>> map2Set(final Injection<Tuple2<K1, V1>, V2> inj) {
        return (Injection<Map<K1, V1>, Set<V2>>)CollectionInjections$class.map2Set(this, inj);
    }
    
    @Override
    public <V1, V2> Injection<Set<V1>, List<V2>> set2List(final Injection<V1, V2> inj) {
        return (Injection<Set<V1>, List<V2>>)CollectionInjections$class.set2List(this, inj);
    }
    
    @Override
    public <V1, V2> Injection<Set<V1>, Vector<V2>> set2Vector(final Injection<V1, V2> inj) {
        return (Injection<Set<V1>, Vector<V2>>)CollectionInjections$class.set2Vector(this, inj);
    }
    
    @Override
    public <V1, V2> Injection<List<V1>, List<V2>> list2List(final Injection<V1, V2> inj) {
        return (Injection<List<V1>, List<V2>>)CollectionInjections$class.list2List(this, inj);
    }
    
    @Override
    public <V1, V2> Injection<Set<V1>, Set<V2>> set2Set(final Injection<V1, V2> inj) {
        return (Injection<Set<V1>, Set<V2>>)CollectionInjections$class.set2Set(this, inj);
    }
    
    @Override
    public <A, B, C extends TraversableOnce<A>, D extends TraversableOnce<B>> Injection<C, D> toContainer(final Function2<D, C, Object> goodInv, final Injection<A, B> inj, final CanBuildFrom<Nothing$, B, D> cd, final CanBuildFrom<Nothing$, A, C> dc) {
        return (Injection<C, D>)CollectionInjections$class.toContainer(this, goodInv, inj, cd, dc);
    }
    ...
    public <A, B> Function1<A, B> toFunction(final Injection<A, B> inj) {
        return inj.toFunction();
    }
    
    public <A, B> B apply(final A a, final Injection<A, B> inj) {
        return inj.apply(a);
    }
    
    public <A, B> Try<A> invert(final B b, final Injection<A, B> inj) {
        return inj.invert(b);
    }
    
    public <A, B> Injection<A, B> build(final Function1<A, B> to, final Function1<B, Try<A>> from) {
        return (Injection<A, B>)new Injection$$anon.Injection$$anon$5((Function1)to, (Function1)from);
    }
    
    public <A, B> Injection<A, B> buildCatchInvert(final Function1<A, B> to, final Function1<B, A> from) {
        return (Injection<A, B>)new Injection$$anon.Injection$$anon$6((Function1)to, (Function1)from);
    }
    
    public <A, B> Injection<A, B> connect(final Injection<A, B> bij) {
        return bij;
    }
    
    public <A, B, C> Injection<A, C> connect(final Injection<A, B> bij, final Injection<B, C> bij2) {
        return bij.andThen(bij2);
    }
    
    public <A, B, C, D> Injection<A, D> connect(final Injection<A, B> bij, final Injection<B, C> bij2, final Injection<C, D> bij3) {
        return this.connect(bij, bij2).andThen(bij3);
    }
    
    public <A, B, C, D, E> Injection<A, E> connect(final Injection<A, B> bij, final Injection<B, C> bij2, final Injection<C, D> bij3, final Injection<D, E> bij4) {
        return this.connect(bij, bij2, bij3).andThen(bij4);
    }
    
    public <A, B> Injection<A, Either<B, A>> either1() {
        return (Injection<A, Either<B, A>>)new Injection$$anon.Injection$$anon$7();
    }
    
    public <A, B> Injection<A, B> fromBijectionRep(final ImplicitBijection<A, B> bij) {
        return (Injection<A, B>)new Injection$$anon.Injection$$anon$8((ImplicitBijection)bij);
    }
    
    public <A> Injection<A, Option<A>> option() {
        return (Injection<A, Option<A>>)new Injection$$anon.Injection$$anon$9();
    }
    
    public <A> Injection<A, A> identity() {
        return (Injection<A, A>)new Injection$$anon.Injection$$anon$10();
    }
    
    public <T> Injection<Class<T>, String> class2String() {
        return (Injection<Class<T>, String>)new ClassInjection();
    }
    
    public <A, B> Injection<A, B> fromBijection(final Bijection<A, B> bij) {
        return (Injection<A, B>)new Injection$$anon.Injection$$anon$11((Bijection)bij);
    }
    
    public <A, B> Injection<A, B> subclass(final ClassTag<A> cmf) {
        return CastInjection$.MODULE$.of(cmf);
    }
    
    public <A, C, B, D> PartialFunction<B, D> toPartial(final Function1<A, C> fn, final Injection<A, B> inj1, final Injection<C, D> inj2) {
        return (PartialFunction<B, D>)new Injection$$anon.Injection$$anon$13((Function1)fn, (Injection)inj1, (Injection)inj2);
    }
    
    public <A, B> Bijection<A, B> unsafeToBijection(final Injection<A, B> inj) {
        return (Bijection<A, B>)new Injection$$anon.Injection$$anon$12((Injection)inj);
    }
    ...
    private Injection$() {
        ...
        CollectionInjections$class.$init$(this);
    }
}
