...
public class Base64 extends BaseNCodec
{
    ...
    public Base64(final int n, final byte[] array, final boolean b) {
        ...
        if (array != null) {
            if (this.containsAlphabetOrPad(array)) {
                throw new IllegalArgumentException("lineSeparator must not contain base64 characters: [" + BaseNCodec.newUtf8(array) + "]");
            }
            if (n > 0) {
    ...
    public static boolean isBase64(final String s) {
        return isBase64(BaseNCodec.getBytesUtf8(s));
    }
    ...
    public static String encodeBase64String(final byte[] array) {
        return BaseNCodec.newUtf8(encodeBase64(array, false));
    }
    ...
    public static String encodeBase64URLSafeString(final byte[] array) {
        return BaseNCodec.newUtf8(encodeBase64(array, false, true));
    }
