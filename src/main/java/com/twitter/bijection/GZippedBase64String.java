...
public final class GZippedBase64String implements Product, Serializable
{
    ...
    public String copy(final String str) {
        return GZippedBase64String$.MODULE$.copy$extension(this.str(), str);
    }
    
    public String copy$default$1() {
        return GZippedBase64String$.MODULE$.copy$default$1$extension(this.str());
    }
    
    @Override
    public String productPrefix() {
        return GZippedBase64String$.MODULE$.productPrefix$extension(this.str());
    }
    
    @Override
    public int productArity() {
        return GZippedBase64String$.MODULE$.productArity$extension(this.str());
    }
    
    @Override
    public Object productElement(final int x$1) {
        return GZippedBase64String$.MODULE$.productElement$extension(this.str(), x$1);
    }
    
    @Override
    public Iterator<Object> productIterator() {
        return GZippedBase64String$.MODULE$.productIterator$extension(this.str());
    }
    
    @Override
    public boolean canEqual(final Object x$1) {
        return GZippedBase64String$.MODULE$.canEqual$extension(this.str(), x$1);
    }
    
    @Override
    public int hashCode() {
        return GZippedBase64String$.MODULE$.hashCode$extension(this.str());
    }
    
    @Override
    public boolean equals(final Object x$1) {
        return GZippedBase64String$.MODULE$.equals$extension(this.str(), x$1);
    }
    
    @Override
    public String toString() {
        return GZippedBase64String$.MODULE$.toString$extension(this.str());
    }
    
    public GZippedBase64String(final String str) {
        this.str = str;
